...
xorg-macros_LIB_PC_DEPENDS=	${LOCALBASE}/libdata/pkconfig/xorg-macros.pc:${PORTSDIR}/devel/xorg-macros
xorg-server_BUILD_DEPENDS=	${LOCALBASE}/libdata/pkgconfig/xorg-server.pc:${PORTSDIR}/x11-servers/xorg-server
