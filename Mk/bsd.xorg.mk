...
# this is from xorg-server 1.10.3 pkg-config file Requires.private
USE_XORG+=	renderproto xextproto inputproto kbproto fontsproto \
		videoproto dri2proto xineramaproto
